...
class Aardy < Formula
  ...
  url "https://github.com/aardlabs/cli-release/releases/download/0.10.14/aardy-darwin-amd64-0.10.14.zip"
  sha256 "c03dc416d2ad6b6abdfbb392a3bbaea2c048917a1108207c300166eb6858f37c"
  ...
  test do
    assert_match "0.10.14", shell_output("#{bin}/aardy --version", 2)
  end
end